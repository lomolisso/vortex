...
`ifdef ASIC_SYNTHESIS
            // BUFFER_EX does not support concatenation destinations under
            // ASIC_SYNTHESIS (token-paste on '{' produces an invalid identifier).
            // Pack/unpack through a single intermediate wire instead.
